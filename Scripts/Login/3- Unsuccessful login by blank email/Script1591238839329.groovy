...
WebUI.clearText(findTestObject('Login Portal/inputEmail'))

WebUI.click(findTestObject('Login Portal/buttonContinue'))

WebUI.verifyElementText(findTestObject('Login Portal/messageInputEmailBlank'), GlobalVariable.messageBlankEmail)
