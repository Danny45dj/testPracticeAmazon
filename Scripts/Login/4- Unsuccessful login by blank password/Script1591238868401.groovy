...
WebUI.clearText(findTestObject('Login Portal/inputPassword'))

WebUI.click(findTestObject('Login Portal/buttonSignIn'))

WebUI.verifyElementText(findTestObject('Login Portal/messageInputPassBlank'), GlobalVariable.messageBlankPass)
